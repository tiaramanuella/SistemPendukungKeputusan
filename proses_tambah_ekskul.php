...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query_insert = "INSERT INTO ekstrakurikuler (id_sekolah, nama_ekskul) VALUES (?, ?)";
    $stmt_insert = mysqli_prepare($conn, $query_insert);
    mysqli_stmt_bind_param($stmt_insert, "is", $sekolah_id, $nama_ekskul);

    if (mysqli_stmt_execute($stmt_insert)) {
        // Ekstrakurikuler berhasil ditambahkan, sekarang update tabel sekolah
        ...
        $_SESSION['pesan'] = "Ekstrakurikuler berhasil ditambahkan.";
    } else {
        $_SESSION['pesan'] = "Gagal menambahkan ekstrakurikuler: " . mysqli_error($conn);
    }
